...
Blockly.JavaScript['movebotforward'] = function(block) {
  var number_duration = block.getFieldValue('duration');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_moveforward = Blockly.JavaScript.valueToCode(block, 'moveForward', Blockly.JavaScript.ORDER_ATOMIC) || null;
  // TODO: Assemble JavaScript into code variable.
  var code = 'moveForwardCommand(' + number_duration + ', ' + dropdown_botspeed + ', ' + value_moveforward + ');\n';
  return code;
};

Blockly.JavaScript['movebotbackwards'] = function(block) {
  var number_duration = block.getFieldValue('duration');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_movebackwards = Blockly.JavaScript.valueToCode(block, 'moveBackwards', Blockly.JavaScript.ORDER_ATOMIC) || null;
  // TODO: Assemble JavaScript into code variable.
  var code = 'moveBackwardCommand(' + number_duration + ', ' + dropdown_botspeed + ', ' + value_movebackwards + ');\n';
  return code;
};

Blockly.JavaScript['turnbotright'] = function(block) {
  var number_duration = block.getFieldValue('duration');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_turnbotright = Blockly.JavaScript.valueToCode(block, 'turnBotRight', Blockly.JavaScript.ORDER_ATOMIC) || null;
  // TODO: Assemble JavaScript into code variable.
  var code = 'turnRightCommand(' + number_duration + ', ' + dropdown_botspeed + ', ' + value_turnbotright + ');\n';
  return code;
};

Blockly.JavaScript['turnbotleft'] = function(block) {
  var number_duration = block.getFieldValue('duration');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_turnbotleft = Blockly.JavaScript.valueToCode(block, 'turnBotLeft', Blockly.JavaScript.ORDER_ATOMIC) || null;
  // TODO: Assemble JavaScript into code variable.
  var code = 'turnLeftCommand(' + number_duration + ', ' + dropdown_botspeed + ', ' + value_turnbotleft + ');\n';
  return code;
};

Blockly.JavaScript['spinbotright'] = function(block) {
  var number_duration = block.getFieldValue('duration');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_spinbotright = Blockly.JavaScript.valueToCode(block, 'spinBotRight', Blockly.JavaScript.ORDER_ATOMIC) || null;
  // TODO: Assemble JavaScript into code variable.
  var code = 'hardTurnRightCommand(' + number_duration + ', ' + dropdown_botspeed + ', ' + value_spinbotright + ');\n';
  return code;
};

Blockly.JavaScript['spinbotleft'] = function(block) {
  var number_duration = block.getFieldValue('duration');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_spinbotleft = Blockly.JavaScript.valueToCode(block, 'spinBotLeft', Blockly.JavaScript.ORDER_ATOMIC) || null;
  // TODO: Assemble JavaScript into code variable.
  var code = 'hardTurnLeftCommand(' + number_duration + ', ' + dropdown_botspeed + ', ' + value_spinbotleft + ');\n';
  return code;
};

Blockly.JavaScript['spinbotleftdegrees'] = function(block) {
  var number_degrees = block.getFieldValue('degrees');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_spinbotleftdegrees = Blockly.JavaScript.valueToCode(block, 'spinBotLeftDegrees', Blockly.JavaScript.ORDER_ATOMIC) || null;
  // TODO: Assemble JavaScript into code variable.
  var code = 'turnLeftSpinCustomAngleCommand(' + number_degrees + ', ' + dropdown_botspeed + ', ' + value_spinbotleftdegrees + ');\n';
  return code;
};

Blockly.JavaScript['spinbotrightdegrees'] = function(block) {
  var number_degrees = block.getFieldValue('degrees');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_spinbotrightdegrees = Blockly.JavaScript.valueToCode(block, 'spinBotRightDegrees', Blockly.JavaScript.ORDER_ATOMIC) || null;
  // TODO: Assemble JavaScript into code variable.
  var code = 'turnRightSpinCustomAngleCommand(' + number_degrees + ', ' + dropdown_botspeed + ', ' + value_spinbotrightdegrees + ');\n';
  return code;
};

Blockly.JavaScript['turnbotleftdegrees'] = function(block) {
  var number_degrees = block.getFieldValue('degrees');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_turnbotleftdegrees = Blockly.JavaScript.valueToCode(block, 'turnBotLeftDegrees', Blockly.JavaScript.ORDER_ATOMIC) || null;
  // TODO: Assemble JavaScript into code variable.
  var code = 'turnLeftTurnCustomAngleCommand(' + number_degrees + ', ' + dropdown_botspeed + ', ' + value_turnbotleftdegrees + ');\n';
  return code;
};

Blockly.JavaScript['turnbotrightdegrees'] = function(block) {
  var number_degrees = block.getFieldValue('degrees');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_turnbotrightdegrees = Blockly.JavaScript.valueToCode(block, 'turnBotRightDegrees', Blockly.JavaScript.ORDER_ATOMIC) || null;
  // TODO: Assemble JavaScript into code variable.
  var code = 'turnRightTurnCustomAngleCommand(' + number_degrees + ', ' + dropdown_botspeed + ', ' + value_turnbotrightdegrees + ');\n';
  return code;
};

Blockly.JavaScript['setenabled'] = function(block) {
  var dropdown_isenabled = block.getFieldValue('isEnabled');
  var value_setenabled = Blockly.JavaScript.valueToCode(block, 'setEnabled', Blockly.JavaScript.ORDER_ATOMIC) || null;
  // TODO: Assemble JavaScript into code variable.
  var code = 'setEnabled(' + dropdown_isenabled + ', ' + value_setenabled + ');\n';
  return code;
};
...
Blockly.JavaScript['wait'] = function(block) {
  ...
  // TODO: Assemble JavaScript into code variable.
  var code = 'wait(' + number_duration +')\n';
  return code;
};

Blockly.JavaScript['repeatforever'] = function(block) {
  var statements_repeatforever = Blockly.JavaScript.statementToCode(block, 'repeatForever');
  // TODO: Assemble JavaScript into code variable.
  var code = 'reapeatForever{\n' + statements_repeatforever + '}\n';//'test;\n';
  return code;
};

Blockly.JavaScript['bot'] = function(block) {
  var text_botname = block.getFieldValue('BotName');
  var text_botAddress = block.getFieldValue('BotAddress')
  var value_name = Blockly.JavaScript.valueToCode(block, 'NAME', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = text_botname + ', ' + text_botAddress + ', ' + value_name;
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, Blockly.JavaScript.ORDER_NONE];
};

Blockly.JavaScript['allbots'] = function(block) {
  // TODO: Assemble JavaScript into code variable.
  var code = 'allBots';
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, Blockly.JavaScript.ORDER_NONE];
...
Blockly.JavaScript['circuit'] = function(block) {
  var value_name = Blockly.JavaScript.valueToCode(block, 'NAME', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'circuitName goes here later ' + value_name;
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, Blockly.JavaScript.ORDER_NONE];
};

Blockly.JavaScript['allcircuit'] = function(block) {
  // TODO: Assemble JavaScript into code variable.
  var code = 'allCircuits';
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, Blockly.JavaScript.ORDER_NONE];
};

Blockly.JavaScript['allmotor'] = function(block) {
  // TODO: Assemble JavaScript into code variable.
  var code = 'allMotors';
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, Blockly.JavaScript.ORDER_NONE];
...
Blockly.JavaScript['spinleftmotorforward'] = function(block) {
  var number_duration = block.getFieldValue('duration');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_spinleftmotorforward = Blockly.JavaScript.valueToCode(block, 'spinLeftMotorForward', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'spinLeftMotorForward(' + number_duration + ', ' + dropdown_botspeed + ', ' + value_spinleftmotorforward + ');\n';
  return code;
};

Blockly.JavaScript['spinleftmotorreverse'] = function(block) {
  var number_duration = block.getFieldValue('duration');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_spinleftmotorreverse = Blockly.JavaScript.valueToCode(block, 'spinLeftMotorReverse', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'spinLeftMotorReverse(' + number_duration + ', ' + dropdown_botspeed + ', ' + value_spinleftmotorreverse + ');\n';
  return code;
};

Blockly.JavaScript['spinrightmotorreverse'] = function(block) {
  var number_duration = block.getFieldValue('duration');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_spinrightmotorreverse = Blockly.JavaScript.valueToCode(block, 'spinrightmotorreverse', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'spinRightMotorReverse(' + number_duration + ', ' + dropdown_botspeed + ', ' + value_spinrightmotorreverse + ');\n';
  return code;
};

Blockly.JavaScript['spinrightmotorforward'] = function(block) {
  var number_duration = block.getFieldValue('duration');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_spinrightmotorforward = Blockly.JavaScript.valueToCode(block, 'spinrightmotorforward', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'spinRightMotorForward(' + number_duration + ', ' + dropdown_botspeed + ', ' + value_spinrightmotorforward + ');\n';
  return code;
};

Blockly.JavaScript['turnd1onkliks'] = function(block) {
  var number_duration = block.getFieldValue('duration');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_turnd1onkliks = Blockly.JavaScript.valueToCode(block, 'turnD1OnKliks', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'turnD1OnTime(' + number_duration + ', ' + dropdown_botspeed + ', ' + value_turnd1onkliks + ');\n';
  return code;
};

Blockly.JavaScript['turnd2onkliks'] = function(block) {
  var number_duration = block.getFieldValue('duration');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_turnd2onkliks = Blockly.JavaScript.valueToCode(block, 'turnD2OnKliks', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'turnD2OnTime(' + number_duration + ', ' + dropdown_botspeed + ', ' + value_turnd2onkliks + ');\n';
  return code;
};

Blockly.JavaScript['turnd3onkliks'] = function(block) {
  var number_duration = block.getFieldValue('duration');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_turnd3onkliks = Blockly.JavaScript.valueToCode(block, 'turnD3OnKliks', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'turnD3OnTime(' + number_duration + ', ' + dropdown_botspeed + ', ' + value_turnd3onkliks + ');\n';
  return code;
};

Blockly.JavaScript['turnd4onkliks'] = function(block) {
  var number_duration = block.getFieldValue('duration');
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_turnd4onkliks = Blockly.JavaScript.valueToCode(block, 'turnD4OnKliks', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'turnD4OnTime(' + number_duration + ', ' + dropdown_botspeed + ', ' + value_turnd4onkliks + ');\n';
  return code;
};

Blockly.JavaScript['turnaonkliks'] = function(block) {
  var number_duration = block.getFieldValue('duration');
  var value_turnaonkliks = Blockly.JavaScript.valueToCode(block, 'turnAOnKliks', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'turnAOnTime(' + number_duration + ', ' + value_turnaonkliks + ');\n';
  return code;
};

Blockly.JavaScript['turnd1ontoggle'] = function(block) {
  var checkbox_toggleon = block.getFieldValue('toggleOn') == 'TRUE';
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_turnd1ontoggle = Blockly.JavaScript.valueToCode(block, 'turnD1OnToggle', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'turnD1OnToggle(' + checkbox_toggleon + ', ' + dropdown_botspeed + ', ' + value_turnd1ontoggle + ');\n';
  return code;
};

Blockly.JavaScript['turnd2ontoggle'] = function(block) {
  var checkbox_toggleon = block.getFieldValue('toggleOn') == 'TRUE';
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_turnd2ontoggle = Blockly.JavaScript.valueToCode(block, 'turnD2OnToggle', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'turnD2OnToggle(' + checkbox_toggleon + ', ' + dropdown_botspeed + ', ' + value_turnd2ontoggle + ');\n';
  return code;
};

Blockly.JavaScript['turnd3ontoggle'] = function(block) {
  var checkbox_toggleon = block.getFieldValue('toggleOn') == 'TRUE';
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_turnd3ontoggle = Blockly.JavaScript.valueToCode(block, 'turnD3OnToggle', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'turnD3OnToggle(' + checkbox_toggleon + ', ' + dropdown_botspeed + ', ' + value_turnd3ontoggle + ');\n';
  return code;
};

Blockly.JavaScript['turnd4ontoggle'] = function(block) {
  var checkbox_toggleon = block.getFieldValue('toggleOn') == 'TRUE';
  var dropdown_botspeed = block.getFieldValue('botSpeed');
  var value_turnd4ontoggle = Blockly.JavaScript.valueToCode(block, 'turnD4OnToggle', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'turnD4OnToggle(' + checkbox_toggleon + ', ' + dropdown_botspeed + ', ' + value_turnd4ontoggle + ');\n';
  return code;
};

Blockly.JavaScript['turnaontoggle'] = function(block) {
  var checkbox_toggleon = block.getFieldValue('toggleOn') == 'TRUE';
  var value_turnaontoggle = Blockly.JavaScript.valueToCode(block, 'turnAOnToggle', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = 'turnAOnToggle(' + checkbox_toggleon + ', ' + value_turnaontoggle + ');\n';
  return code;
};
...
Blockly.JavaScript['imagebot'] = function(block) {
  var dropdown_name = block.getFieldValue('NAME');
  var value_name = Blockly.JavaScript.valueToCode(block, 'NAME', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = '...';
...
Blockly.JavaScript['bot_block'] = function(block) {
    var value_name = Blockly.JavaScript.valueToCode(block, 'NAME', Blockly.JavaScript.ORDER_ATOMIC);
    var bot_address = block.getFieldValue('DEVICE_UUID');//block.getField('DEVICE_NAME');
    var bot_name = block.getFieldValue('DEVICE_NAME');
    // TODO: Assemble JavaScript into code variable.
    var code = bot_name + "#?" + bot_address + "! " + value_name;
    // TODO: Change ORDER_NONE to the correct strength.
    return [code, Blockly.JavaScript.ORDER_NONE];
};

Blockly.JavaScript['circuit_block'] = function(block) {
    var value_name = Blockly.JavaScript.valueToCode(block, 'NAME', Blockly.JavaScript.ORDER_ATOMIC);
    var bot_address = block.getFieldValue('DEVICE_UUID');//block.getField('DEVICE_NAME');
    var bot_name = block.getFieldValue('DEVICE_NAME');
    // TODO: Assemble JavaScript into code variable.
...
Blockly.JavaScript['motor_block'] = function(block) {
    var value_name = Blockly.JavaScript.valueToCode(block, 'NAME', Blockly.JavaScript.ORDER_ATOMIC);
    var bot_address = block.getFieldValue('DEVICE_UUID');//block.getField('DEVICE_NAME');
    var bot_name = block.getFieldValue('DEVICE_NAME');
    // TODO: Assemble JavaScript into code variable.
