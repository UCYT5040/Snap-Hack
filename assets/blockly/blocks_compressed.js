...
Blockly.defineBlocksWithJsonArray([{type:"controls_repeat_ext",message0:"%{BKY_CONTROLS_REPEAT_TITLE}",args0:[{type:"field_number",name:"TIMES",check:"Number",min: 1,max: 100,precision:1}],message1:"%{BKY_CONTROLS_REPEAT_INPUT_DO} %1",args1:[{type:"input_statement",name:"DO"}],previousStatement:null,nextStatement:null,colour:"#5f2167", tooltip:"%{BKY_CONTROLS_REPEAT_TOOLTIP}",helpUrl:"%{BKY_CONTROLS_REPEAT_HELPURL}"},{type:"controls_repeat",message0:"%{BKY_CONTROLS_REPEAT_TITLE}",args0:[{type:"field_number",name:"TIMES",value:10,
...
Blockly.defineBlocksWithJsonArray([
{
  ...
  "type": "movebotforward",
  "message0": "Move Forward %1 Time      Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "duration",
...
{
  "type": "movebotbackwards",
  "message0": "Move Backwards %1 Time      Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "duration",
...
{
  "type": "turnbotright",
  "message0": "Turn Right %1 Time      Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "duration",
...
{
  "type": "turnbotleft",
  "message0": "Turn Left %1 Time      Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "duration",
...
{
  "type": "spinbotright",
  "message0": "Spin Right %1 Time      Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "duration",
...
{
  "type": "spinbotleft",
  "message0": "Spin Left %1 Time      Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "duration",
...
{
  "type": "spinbotleftdegrees",
  "message0": "Spin Left %1 Degrees     Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "degrees",
...
{
  "type": "spinbotrightdegrees",
  "message0": "Spin Right %1 Degrees     Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "degrees",
...
{
  "type": "turnbotleftdegrees",
  "message0": "Turn Left %1 Degrees     Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "degrees",
...
{
  "type": "turnbotrightdegrees",
  "message0": "Turn Right %1 Degrees     Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "degrees",
...
{
  "type": "spinleftmotorforward",
  "message0": "Spin Left Motor Forward %1 Time      Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "duration",
...
{
  "type": "spinleftmotorreverse",
  "message0": "Spin Left Motor Reverse %1 Time      Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "duration",
...
{
  "type": "spinrightmotorreverse",
  "message0": "Spin Right Motor Reverse %1 Time      Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "duration",
...
{
  "type": "spinrightmotorforward",
  "message0": "Spin Right Motor Forward %1 Time      Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "duration",
...
{
  "type": "turnd1onkliks",
  "message0": "Turn On D1 %1 Time      Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "duration",
...
{
  "type": "turnd2onkliks",
  "message0": "Turn On D2 %1 Time      Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "duration",
...
{
  "type": "turnd3onkliks",
  "message0": "Turn On D3 %1 Time      Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "duration",
...
{
  "type": "turnd4onkliks",
  "message0": "Turn On D4 %1 Time      Speed %2 %3",
  "args0": [
    {
      "type": "field_number",
      "name": "duration",
...
{
  "type": "turnd1ontoggle",
  "message0": "Turn On D1 %1      Speed %2 %3",
  "args0": [
    {
      "type": "field_checkbox",
      "name": "toggleOn",
...
{
  "type": "turnd2ontoggle",
  "message0": "Turn On D2 %1      Speed %2 %3",
  "args0": [
    {
      "type": "field_checkbox",
      "name": "toggleOn",
...
{
  "type": "turnd3ontoggle",
  "message0": "Turn On D3 %1      Speed %2 %3",
  "args0": [
    {
      "type": "field_checkbox",
      "name": "toggleOn",
...
{
  "type": "turnd4ontoggle",
  "message0": "Turn On D4 %1      Speed %2 %3",
  "args0": [
    {
      "type": "field_checkbox",
      "name": "toggleOn",
